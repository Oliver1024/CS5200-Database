    ...
    <xsl:template match="/ReviewApplication">
        ...
        <table border="1">
            ...
            <xsl:for-each select="Reviews/Review">
                ...
                <tr>
                    <td>
                        <xsl:value-of select="../../Companys/Company/Restaurants/Restaurant[RestaurantId/text()=$restaurantId]/Name"></xsl:value-of>
                    </td>
                    <td>
                        <xsl:value-of select="../../Users/User[UserName/text()=$username]/FirstName"></xsl:value-of>
                    </td>
                    <td>
